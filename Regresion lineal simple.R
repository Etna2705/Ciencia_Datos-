...
#****************************************************************
#Técnica estadistica para crear modelos de variables continuas con ayuda de
#una función predictora. Nos ayuda a predecir y comprender el comportamiento de 
...
#para esto el estimador beta0 es de -281.86, beta1 es de 217.09 y el error 
#standar del residual es 374.8, Por lo tanto, la ecuación del modelo quedaría 
#del siguiente modo:
#           
